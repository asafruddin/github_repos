...
abstract class _RepositoryModel extends RepositoryModel {
  const factory _RepositoryModel(
      ...
      final int? watchers,
      final String? defaultBranch,
      final Permissions? permissions}) = _$RepositoryModelImpl;
  const _RepositoryModel._() : super._();
...
class _$LicenseImpl extends _License {
  const _$LicenseImpl({this.key, this.name, this.spdxId, this.url, this.nodeId})
      : super._();
...
abstract class _License extends License {
  const factory _License(
      ...
      final String? spdxId,
      final String? url,
      final String? nodeId}) = _$LicenseImpl;
